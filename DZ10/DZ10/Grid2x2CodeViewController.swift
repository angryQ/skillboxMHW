...
class Grid2x2CodeViewController: UIViewController {
    ...
    private func createGrid() {
        let countOfRowsOnScreen: CGFloat = 2
        let countOfItemsPerRow: CGFloat = 2
        ...
        let paddingBottom: CGFloat = 15 //отступ между строками
        ...
        let widthPerItem = (holderView.frame.width - paddingVertical) / countOfItemsPerRow
        let heightPerItem =  (holderView.frame.height - paddingBottom) / countOfRowsOnScreen
        var row: CGFloat = 0
        ...
        while endIndexInSubArray < Int(countOfItemsPerRow * countOfRowsOnScreen) {
            ...
            for _ in  startIndexInSubArray...endIndexInSubArray {
                ...
                //увеличиваем колонку и устанавливаем "х" для второго элемента в следующую колонку
                column += 1
                xPos = (widthPerItem + paddingVertical) * column
            }
            //увеличиваем строку и устанавливаем "х" в первую колонку, а "у" на следующую строку
            row += 1
